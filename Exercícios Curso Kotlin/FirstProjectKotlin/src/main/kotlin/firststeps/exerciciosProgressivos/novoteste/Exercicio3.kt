...
fun main() {
    ...
    val idade = calculaIdade(anoNascimentoLido)//argumento é o valor que passa para o parametro anoNascimento da função
    print("Você tem $idade seu coroa")
}

fun calculaIdade (anoNascimento: Int)= LocalDate.now().year - anoNascimento
